...
export default function NewPemberian() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setBalitaName((db.items?.[0]?.nama_balita) || "");
    })();
  }, [params.balitaId]);
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-semibold mb-2">Tambah Monitoring: PKMK Pemberian</h1>
      {(balitaName || kohort) && (
      ...
      {/* Riwayat pemberian */}
      <div className="mt-6">
        <h2 className="text-lg font-semibold mb-2">Riwayat Pemberian</h2>
          ...
          <Table>
            <TableHeader className="bg-[var(--background)]">
              <TableRow>
                ...
                <TableHead>Jumlah Unit (ml)</TableHead>
                <TableHead>Formulasi</TableHead>
            ...
            <TableBody>
              {history.map((h:any) => (
                <TableRow key={h.id}>
                  ...
                  <TableCell>{h.jumlah_unit}</TableCell>
                  <TableCell>{h.jenis_formulasi}</TableCell>
              ...
              {history.length === 0 && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center text-[var(--muted-foreground)]">Belum ada data pemberian.</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
